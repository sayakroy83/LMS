...
const Player = () => {
  ...
  const getCourseData = () => {
    ...
    if (course) {
      ...
      if (Array.isArray(course.courseRatings) && userData && userData._id) {
  ...
  return courseData ? (
    ...
    <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
      ...
      <div className='md:mt-10'>
        {playerData ? (
          <div>
            <YouTube videoId={playerData.lectureUrl.split('/').pop().split('?')[0]} iframeClassName='w-full aspect-video'/> 
